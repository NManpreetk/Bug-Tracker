...
namespace BugTrackerApplication.Controllers
{
    public class TicketAttachmentsController : Controller
    {
        ...
        {
            var attachments = db.Attachments.Include(t => t.Ticket);
        ...
        public ActionResult Create([Bind(Include = "Id,TicketId,FilePath,Description,Created,UserId,FileUrl")] TicketAttachment ticketAttachment, HttpPostedFileBase image)
        {
            if (ModelState.IsValid)
            {
                ...
                //    attachment.Description = ticketAttachment;
